          ...
          <div className="row row-cols-lg-3 row-cols-2 gy-5 mt-3">
              ...
              >
                <>
                  <div className="cate-icon mx-auto">
                    <Image src={'/images/icons/cate1.svg'} alt=""  width={100}/>
                  </div>
                  <h5>Adventure</h5>
                </>
              </Link>
            ...
            <div className="col">
              ...
              >
                <>
                  <div className="cate-icon mx-auto">
                    <Image src={'/images/icons/cate2.svg'} alt="" />
                  </div>
                  <h5>Group Tour</h5>
                </>
              </Link>
            ...
            <div className="col">
              ...
              >
                <>
                  <div className="cate-icon mx-auto">
                    <Image src={'/images/icons/cate3.svg'} alt="" />
                  </div>
                  <h5>Couple Tour</h5>
                </>
              </Link>
            ...
            <div className="col">
              ...
              >
                <>
                  <div className="cate-icon mx-auto">
                    <Image src={'/images/icons/cate4.svg'} alt="" />
                  </div>
                  <h5>Single Tour</h5>
                </>
              </Link>
            ...
            <div className="col">
              ...
              >
                <>
                  <div className="cate-icon mx-auto">
                    <Image src={'/images/icons/cate5.svg'} alt="" />
                  </div>
                  <h5>Honeymoon</h5>
                </>
              </Link>
            ...
            <div className="col">
              ...
              >
                <>
                  <div className="cate-icon mx-auto">
                    <Image src={'/images/icons/cate6.svg'} alt="" />
                  </div>
                  <h5>Sea Beach</h5>
                </>
              </Link>
            ...
            <div className="col">
              ...
              >
                <>
                  <div className="cate-icon mx-auto">
                    <Image src={'/images/icons/cate7.svg'} alt="" />
                  </div>
                  <h5>Mountain Tour</h5>
                </>
              </Link>
                ...
                <div className="nav-right d-xl-flex d-none">
                  ...
                  <div className="nav-right-hotline d-xxl-flex d-none">
                    <div className="hotline-icon">
                      <Image src={'/images/icons/header-phone.svg'} alt="" width={100} height={100} />
                    </div>
