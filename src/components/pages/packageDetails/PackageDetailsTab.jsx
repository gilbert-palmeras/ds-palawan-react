            ...
            <div className="p-info-featured-img row position-relative g-3  row-cols-1 row-cols-sm-2">
              <div className="col">
                <div className="featured-img">
                  <Image src={'/images/package/feat-img1.png'} alt="PackageIMG" />
                </div>
              </div>
              <div className="col">
                <div className="featured-img">
                  <Image src={'/images/package/feat-img2.png'} alt="PackageIMG" />
                </div>
              </div>
              <div className="featured-video position-absolute ">
                <Image src={'/images/package/feat-img3.png'} alt="PackageIMG" />
                ...
                <tr>
                  <td colSpan={2} className="tour-transport-col">
                    <div className="tour-transport  d-flex align-items-center justify-content-center">
                      <Image src={'/images/icons/bus.svg'} alt="PackageIMG" />
              ...
              <div className="row g-4">
                <div className="col-6">
                  <div className="package-gallary-item">
                    ...
                    >
                      <Image src={'/images/gallary/pgl-1.png'} alt="PackageIMG" />
                    </a>
                  </div>
                </div>
                <div className="col-6">
                  <div className="package-gallary-item">
                    <a
                      ...
                      data-caption="Caption Here"
                    >
                      <Image src={'/images/gallary/pgl-2.png'} alt="PackageIMG" />
                    </a>
                  </div>
                </div>
                <div className="col-12">
                  <div className="package-gallary-item">
                    <a
                      ...
                      data-caption="Caption Here"
                    >
                      <Image src={'/images/gallary/pgx-1.png'} alt="PackageIMG" />
                    </a>
                  </div>
                </div>
                <div className="col-6">
                  <div className="package-gallary-item">
                    <a
                      ...
                      data-caption="Caption Here"
                    >
                      <Image src={'/images/gallary/pgl-3.png'} alt="PackageIMG" />
                    </a>
                  </div>
                </div>
                <div className="col-6">
                  <div className="package-gallary-item">
                    <a
                      ...
                      data-caption="Caption Here"
                    >
                      <Image src={'/images/gallary/pgl-4.png'} alt="PackageIMG" />
                    </a>
                  </div>
                </div>
                <div className="col-12">
                  <div className="package-gallary-item">
                    <a
                      ...
                      data-caption="Caption Here"
                    >
                      <Image src={'/images/gallary/pgx-2.png'} alt="PackageIMG" />
                    </a>
                  </div>
                </div>
                <div className="col-6">
                  <div className="package-gallary-item">
                    <a
                      ...
                      data-caption="Caption Here"
                    >
                      <Image src={'/images/gallary/pgl-5.png'} alt="PackageIMG" />
                    </a>
                  </div>
                </div>
                <div className="col-6">
                  <div className="package-gallary-item">
                    <a
                      ...
                      data-caption="Caption Here"
                    >
                      <Image src={'/images/gallary/pgl-6.png'} alt="PackageIMG" />
                    </a>
                  </div>
                </div>
                <div className="col-12">
                  <div className="package-gallary-item">
                    <a
                      ...
                      data-caption="Caption Here"
                    >
                      <Image src={'/images/gallary/pgx-3.png'} alt="PackageIMG" />
                    </a>
                  </div>
                </div>
              </div>
