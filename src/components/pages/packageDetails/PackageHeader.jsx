      ...
      <div className="pd-header">
        <div className=" pd-top row row-cols-lg-4 row-cols-md-2 row-cols-2 gy-4">
          <div className="col">
            <div className="pd-single-info">
              <div className="info-icon">
                <Image src={'/images/icons/pd1.svg'} alt="PackageIMG" />
              </div>
              <div className="info">
                <h6>Duration</h6>
                <span>4 Days</span>
          ...
          <div className="col">
            <div className="pd-single-info">
              <div className="info-icon">
                <Image src={'/images/icons/pd2.svg'} alt="PackageIMG" />
              </div>
              <div className="info">
                <h6>Tour Type</h6>
          ...
          <div className="col">
            <div className="pd-single-info">
              <div className="info-icon">
                <Image src={'/images/icons/pd3.svg'} alt="PackageIMG" />
              </div>
              <div className="info">
                <h6>Group Size</h6>
                <span>30 People</span>
          ...
          <div className="col">
            <div className="pd-single-info">
              <div className="info-icon">
                <Image src={'/images/icons/pd4.svg'} alt="PackageIMG" />
              </div>
              <div className="info">
                <h6>Tour Guide</h6>
                <span>05 People</span>
        ...
        <div className="pd-thumb">
          <Image src={'/images/package/pd-thumb.png'} alt="PackageIMG" />
        </div>
