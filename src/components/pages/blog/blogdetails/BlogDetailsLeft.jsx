      ...
      <div className="col-lg-8">
        <div className="blog-details">
          ...
          <div className="post-thumb">
            <Image src={'/images/blog/blog-thumb-xl1.png'} alt="blogDetailsIMG" />
          </div>
          ...
          <div className="post-body">
            ...
            <div className="blog-quote-box-one d-flex flex-column flex-sm-row">
              <div className="quote-icon">
                <Image src={'/images/icons/blogquote.svg'} alt="blogDetailsIMG" />
              </div>
              <blockquote>
                <p>
            ...
            <div className="post-innner-image">
              <Image src={'/images/blog/blog-d-inner.png'} alt="blogDetailsIMG" />
            </div>
