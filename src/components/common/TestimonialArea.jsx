              ...
              <SwiperSlide className="swiper-slide">
                <div className="testimonial-card testimonial-card-alpha">
                  <div className="testimonial-overlay-img">
                    <Image src={'/images/reviewer/reviewer.png'} alt="images" width={100} height={100} />
                  </div>
                  <div className="testimonial-card-top">
                    ...
                    <div className="testimonial-thumb">
                      <Image src={'/images/reviewer/r-sm1.png'} alt="images" width={100} height={100} />
                    </div>
              ...
              <SwiperSlide className="swiper-slide">
                <div className="testimonial-card testimonial-card-alpha">
                  ...
                  <div className="testimonial-card-top">
                    ...
                    <div className="testimonial-thumb">
                      <Image src={'/images/reviewer/r-sm2.png'} alt="images" width={100} height={100} />
                    </div>
              ...
              <SwiperSlide className="swiper-slide">
                <div className="testimonial-card testimonial-card-alpha">
                  ...
                  <div className="testimonial-card-top">
                    ...
                    <div className="testimonial-thumb">
                      <Image src={'/images/reviewer/r-sm3.png'} alt="images" width={100} height={100} />
                    </div>
